...
var checkValidServiceWorker, isLocalhost, registerValidSW;
    ...
    return window.addEventListener('load', function() {
      ...
      if (isLocalhost) {
        ...
        return navigator.serviceWorker.ready.then(function() {
          return console.log('This web app is being served cache-first by a service  worker. To learn more, visit https://goo.gl/SC7cgQ');
        });
      } else {
...
registerValidSW = function(swUrl) {
  return navigator.serviceWorker.register(swUrl).then(function(registration) {
    return registration.onupdatefound = function() {
      var installingWorker;
      installingWorker = registration.installing;
      return installingWorker.onstatechange = function() {
...
export var unregister = function() {
